...
public class DateTimeFormatInfoProcessor extends Processor {
    ...
    protected void generateArgMethodRedirect(PrintWriter pw, String category, GwtLocale locale,
        ...
        if (value != null) {
            ...
            final StringGenerator gen = StringGenerator.create(buf);
            try {
    ...
    protected void writeOneJavaFile(String path, String packageName, String className,
        ...
        if (locale.isDefault()) {
            pw.println();
            pw.println("import org.gwtproject.i18n.shared.cldr.DateTimeFormatInfo;");
            pw.println();
            pw.println("/**");
            ...
            pw.println(" */");
            pw.println();
            pw.println("import org.gwtproject.i18n.shared.cldr.DateTimeFormatInfoImpl;");
            pw.println("");
        }
        ...
        for (Entry<String, String> entry : FORMAT_BY_METHOD.entrySet()) {
    ...
    protected void writeOutputFiles() throws IOException {
        ...
        String factoryPath = "shared/cldr/impl/DateTimeFormatInfo_factory.java";
        ...
        factoryWriter.println();
        factoryWriter.println("import org.gwtproject.i18n.shared.cldr.DateTimeFormatInfo;");
        factoryWriter.println();
        ...
        for (GwtLocale locale : sorted) {
            ...
            String path = "shared/cldr/impl/" + className + ".java";
